...
\begin{exemple}
	L'ensemble des degrés des sommets de $G$ (\ref{g.maison}).
\end{exemple}
...
\begin{definition}
	On dit que deux sommets sont \textbf{liés} si et seulement si, il existe un chemin d'extrémités $x$ et $y$. On note la liaison:
	\[
	x \leadsto y	
	\]
\end{definition}
...
\begin{remarque}
	On appelle \textbf{graphe connexe} les graphes à une composante connexe.
\end{remarque}
